...
router.get(
  '/export-data',
  usePermissions([SystemPermission.ALARM_MANAGEMENT_VIEW]),
  alarmController.exportData
);
router.delete(
  '/all',
  usePermissions([SystemPermission.ALARM_MANAGEMENT_DELETE]),
  alarmController.removeAllAlarm
);
router.delete(
  '/:id',
  usePermissions([SystemPermission.ALARM_MANAGEMENT_DELETE]),
