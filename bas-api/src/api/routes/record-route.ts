...
router.get(
  ...
  recordController.getAggregates
);
router.get(
  '/export-data/:id',
  usePermissions([SystemPermission.RECORDING_MANAGEMENT_VIEW]),
  recordController.exportData
);
router.get(
  '/chart/:id',
  usePermissions([SystemPermission.RECORDING_MANAGEMENT_VIEW]),
  recordController.getChart
);

router.post(
  '/:id/sync',
  usePermissions([SystemPermission.RECORDING_MANAGEMENT_VIEW]),
  recordController.sync
);
...
router.get(
  ...
  recordLatestValidator,
  recordController.findLatestRecord
);

router.delete(
  '/:id',
  usePermissions([SystemPermission.RECORDING_MANAGEMENT_DELETE]),
  recordController.remove
);
router.get(
  '/:id',
  usePermissions([SystemPermission.RECORDING_MANAGEMENT_VIEW]),
  recordController.findAllByRecord
);
