...
export default class DaysView extends React.Component {
  ...
  render() {
    return (
      <div className="rdtDays" style={{ display: "flex" }}>
        <div className="rdtDaysLeft" style={{ minWidth: 320 }}>
          <table>
            <thead>
        ...
        <div className="rdtDaysRight">{this.renderFooter()}</div>
      </div>
    );
  }
    ...
    return (
      <tfoot>
        <tr>
          ...
          <td colSpan={7}>{this.props.renderFooter}</td>
        </tr>
      </tfoot>
    );
  }
