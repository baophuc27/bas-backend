...
const { DATE_FORMAT } = require("../../constants/date-time.constant");
...
var getValidatedMonths = function (range, minDate, maxDate) {
  ...
  if (startDate && endDate) {
    ...
    return [
      newStart,
      dateFns_85(newStart, newEnd) ? dateFns_6(newStart, 1) : newEnd,
    ];
  }
...
var Header = function (_a) {
  ...
  var lblMonths = monthsLabels ? monthsLabels : MONTHS;
  return React__default.createElement(
    core.Grid,
    { container: true, justify: "space-between", alignItems: "center" },
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        lblMonths.map(function (month, idx) {
          return React__default.createElement(
            core.MenuItem,
            { key: month, value: idx },
            month
...
var Month = function (props) {
  ...
  var helpers = props.helpers,
    ...
    weekDaysLabels = props.weekDaysLabels,
    monthsLabels = props.monthsLabels;
  // eslint-disable-next-line react/destructuring-assignment
  var _a = props.navState,
    back = _a[0],
    forward = _a[1];
  var lblWeekDays = weekDaysLabels ? weekDaysLabels : WEEK_DAYS;
  return React.createElement(
    core.Paper,
    { square: true, elevation: 0, className: classes.root },
    React.createElement(
      core.Grid,
      { container: true },
      ...
      React.createElement(
        ...
        lblWeekDays.map(function (day) {
          return React.createElement(
            core.Typography,
            { color: "textSecondary", key: day, variant: "caption" },
            day
          );
        })
      ),
            ...
            React.createElement(
              ...
              week.map(function (day) {
                ...
                return React.createElement(Day, {
                  key: dateFns_50(day, DATE_FORMAT),
                  filled: isStart || isEnd,
                  outlined: dateFns_102(day),
                  highlighted: highlighted && !isRangeOneDay,
                  disabled:
                    !dateFns_85(date, day) ||
                    !dateFns_108(day, minDate, maxDate),
...
var Menu = function (props) {
  ...
  var lblStartDate = startDateLabel ? startDateLabel : "Start Date";
  var lblEndDate = endDateLabel ? endDateLabel : "End Date";
  return React__default.createElement(
    core.Paper,
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          core.Grid,
          { container: true, className: classes.header, alignItems: "center" },
          React__default.createElement(
            core.Grid,
            { item: true, className: classes.headerItem },
            React__default.createElement(
              core.Typography,
              { variant: "subtitle1" },
              startDate ? dateFns_50(startDate, "MMMM DD, YYYY") : lblStartDate
            )
          ),
          React__default.createElement(
            core.Grid,
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              core.Typography,
              { variant: "subtitle1" },
              endDate ? dateFns_50(endDate, "MMMM DD, YYYY") : lblEndDate
            )
          )
        ),
      ...
      React__default.createElement(
        core.Grid,
        null,
        React__default.createElement(DefinedRanges, {
...
var DateRangePicker = function (props) {
  ...
  var _c = React.useState(__assign({}, initialDateRange)),
    dateRange = _c[0],
    setDateRange = _c[1];
  var _d = React.useState(),
    hoverDay = _d[0],
    setHoverDay = _d[1];
  var _e = React.useState(intialFirstMonth || today),
    firstMonth = _e[0],
    setFirstMonth = _e[1];
  var _f = React.useState(initialSecondMonth || dateFns_6(firstMonth, 1)),
    secondMonth = _f[0],
    setSecondMonth = _f[1];
  var startDate = dateRange.startDate,
    endDate = dateRange.endDate;
...
var DateRangePickerWrapper = function (props) {
  ...
  var handleKeyPress = function (event) {
    var _a;
    return (
      ((_a = event) === null || _a === void 0 ? void 0 : _a.key) === "Escape" &&
      handleToggle()
    );
  };
...
function generateClassName(rule, sheet) {
  ...
  if (sheet && sheet.options.meta) {
    return (
      prefix + "-" + sheet.options.meta + "-" + rule.key + "-" + ruleCounter
    );
  }
